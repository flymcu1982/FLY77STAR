...
0. **`CANON_FLY77STAR_20260716_final.md`** — 2026-07-16、YU承認・確定版のFLY77STAR CANON(完全制作基盤)。ブランド・組織・哲学・キャラクター・作品ラインアップ・制作ワークフロー・収益化戦略の最上位資料。「すべてのAI社員・クリエイターは、実装前に必ずこのファイルを参照」と定められている。既存リポジトリ資料との整合性確認は進行中(未解消の差分はHANDOFF.md参照)
