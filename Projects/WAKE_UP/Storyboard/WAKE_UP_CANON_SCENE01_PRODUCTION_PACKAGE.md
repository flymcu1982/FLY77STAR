...
## D-0. Director固定運用ルール（2026-07-21追加）

**15秒ワンカット（Seedance 2.0）は最大2回まで**: 1回目=評価、2回目=軽修正。通らなければ3セグメント分割案へ即切り替え。

**Panel 2 QC基準（Director指定）**:
- [ ] 上空から地上への移行が読める
- [ ] 大通りから路地への流れが自然
- [ ] ブルーアワーの色味維持
- [ ] 読める文字・ロゴなし
...
**Panel 3 QC基準（Director指定）**: 雰囲気よりも**背景としての安定性を優先**（Scene 1の着地点かつPanel 4の背景資産）
- [ ] 一目でクラブ入口と分かる
- [ ] ネオンは判読不能
- [ ] ロゴや実在性なし
- [ ] ドア形状がシンプル
