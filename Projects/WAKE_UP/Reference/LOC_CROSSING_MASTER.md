...
- **CANON(採用済み素材、2026-07-16)**: GitHub `/CANON_FLY77STAR_20260716_final.md` §6のWAKE UP新構成において、CROSSING (ACT01 SHIBUYA_NIGHT、冒頭の現実渋谷)として円環構造の起点として位置づけられ、CANON必須となった。本ファイルはLegacy構造(旧12カット)との物語統合とは別に、Location Referenceとして有効
