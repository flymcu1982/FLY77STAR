...
4つの役割名はGitHub `AI_RULES.md` にまだ正式定義されていない(Obsidian Vault `03_Company/Decisions/2026-07-09_未決事項リスト.md` の1番、未決)。既存ロール(Higgsfield/Palmier等)の改名か新設部署かでAI_RULES.mdの変更範囲が変わるため、これはFLY77STAR U.の判断待ち。
